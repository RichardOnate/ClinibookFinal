document.addEventListener("DOMContentLoaded", function () {
            ...
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    try {
                        ...
                        var fechaSelectorGrad = document.getElementById("fechaSelectorTrata");
    ...
    function generarPDF() {
        var fechaSeleccionada = document.getElementById("fechaSelectorTrata").value;
        ...
        if (fechaSeleccionada !== "") {
            ...
            var docDefinition = {
                pageSize: "A4",
                content: [
                    { text: "Informe de Tratamientos", style: "header" },
                    {
    ...
    var btnExportarPDF = document.getElementById("Export-trata");
    if (btnExportarPDF) {
