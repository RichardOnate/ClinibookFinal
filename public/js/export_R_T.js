document.addEventListener("DOMContentLoaded", function () {
    document
        .getElementById("btn-export-trata-pdf")
        .addEventListener("click", function () {
            // Obtener los datos del formulario
            var especialista = document.getElementById("especialista_2").value;
            var rut = document.getElementById("rut_2").value;
            var nombre = document.getElementById("nombre_2").value;
...
function obtenerNombreArchivo(nombre, rut) {
    ...
    return parteNombre + "_" + parteRut + "_RT.pdf";
}
