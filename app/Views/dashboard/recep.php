          ...
          <?php foreach ($citas as $cita) : ?>
            ...
            <div data-id="<?= esc($cita['ESTADO_CITA']) ?>" class="max-w-md w-full bg-white shadow-lg rounded-lg mx-5 carta">
              <div class="px-4 py-2">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400" data-id="<?= esc($cita['ESTADO_CITA']) ?>">Estado de la
                  cita:
      ...
      document.addEventListener("DOMContentLoaded", function() {
        ...
        cartas.forEach(function(carta) {
          ...
          switch (estadoCita) {
            ...
            case 'Cancelada':
              carta.classList.remove('bg-white');
              carta.classList.add('bg-red-200');
              confirmarBtn.disabled = true;
              cancelarBtn.disabled = true; // Clase de color para estado 'Cancelada'
              break;
            case 'Confirmada':
              carta.classList.remove('bg-white');
