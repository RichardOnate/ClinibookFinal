  ...
  <div class="p-4 sm:ml-64">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3  gap-4 mb-4">
        ...
        <div class=" flex items-center justify-center rounded p-5 border-blue-600 border-2 bg-white text-white ">
          ...
          <div class="flex">
            <h3 class="text-xl text-blue-700 font-bold md:text-2xl lg:text-5xl">Pendientes por atender hoy : </h3>
        ...
        <div class=" flex items-center justify-center rounded p-5 border-2 border-emerald-700 bg-white text-white ">
          ...
          <div class="flex">
            <h3 class="text-lg text-emerald-700 font-bold md:text-2xl lg:text-5xl">Total citas atendidas hoy : </h3>
