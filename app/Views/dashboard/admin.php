  ...
  <div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      ...
      <div class="grid grid-cols-3 gap-4 mb-4">
        <!-- ------------------------------------------------------------------------------------------------ -->
        <div
          class="flex flex-col sm:flex-row items-center justify-center h-auto w-auto rounded bg-white dark:bg-blue-700 text-white">
          <svg class="w-6 h-6 text-blue-700 dark:text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex flex-col sm:flex-row items-center ">
            ...
            <span class="text-xl text-blue-700 lg:text-4xl  justify-center text-center">
              <?= esc($conteo['pacientes']) ?>
            </span>
          </div>
        </div>
        ...
        <!-- ------------------------------------------------------------------------------------------------------------ -->
        <div
          class="flex flex-col sm:flex-row items-center justify-center h-24 rounded bg-white dark:bg-blue-700 text-white">
          <svg class="w-6 h-6 text-red-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex flex-col sm:flex-row items-center ">
            ...
            <span class="text-xl text-red-700 sm:text-4xl  justify-center text-center">
              <?= esc($conteo['trabajadores']) ?>
            </span>
          </div>
        </div>
        <!-- ----------------------------------------------------------------------------------------------- -->
        <div
          class="flex flex-col sm:flex-row items-center justify-center h-24 rounded bg-white dark:bg-blue-700 text-white">
          <svg class="w-6 h-6 text-emerald-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex flex-col sm:flex-row items-center ">
            ...
            <span class="text-xl text-emerald-700 sm:text-4xl  justify-center text-center">
              <?= esc($conteo['citas']) ?>
            </span>
          </div>
        </div>
          ...
          <form>
            <div class="flex gap-2">
              ...
              <button id="dropdown-button" data-dropdown-toggle="dropdown"
                class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                type="button">Todos los usuarios <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true"
              ...
              <div id="dropdown"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                  <li>
                    <button type="button"
                      class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pacientes</button>
                  </li>
                  <li>
                    <button type="button"
                      class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Doctores</button>
                  </li>
                  <li>
                    <button type="button"
                      class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Recepcionistas</button>
                  </li>
                  <li>
                    <button type="button"
                      class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Enfermeras/os</button>
                  </li>
                </ul>
              </div>
              ...
              <button title="Agregar Sucursal" type="button"
                class=" abrirSucursal cursor-pointer w-auto md:w-auto px-6 py-3 text-base font-medium text-white bg-blue-700 rounded-lg hover:bg-white focus:ring-4 focus:ring-gray-300 focus:ring-opacity-50">
    ...
    <div class="max-w-lg h-auto mx-auto gap-2 md:mb-28 rounded-lg bg-white p-4 relative">
      ...
      <form action="/insert-suc" method="post">
        ...
        <div class="mb-4">
          ...
          <select id="region" onchange="cargarProvincias()" name="region"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
        ...
        <div class="mb-4">
          ...
          <select id="provincia" onchange="cargarComunas()" name="provincia"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
        ...
        <div class="flex flex-col mt-5 md:flex-row md:justify-between">
          <button type="submit"
            class="w-full md:w-auto px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:ring focus:ring-blue-300 focus:ring-opacity-50">Guardar</button>
        </div>
    ...
    <div class="max-w-lg h-auto mx-auto gap-2 md:mb-28 rounded-lg bg-white p-4 relative">
      ...
      <form action="/act-suc" method="post">
        ...
        <div class="mb-4">
          <!-- Direccion -->
          <label for="direccion" class="block text-sm font-medium text-gray-700">Dirección </label>
          <input type="text" id="direccion_s" value="" name="direccion"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
        </div>
        <div class="grid grid-cols-2 gap-4">
          <div class="mb-4">
            <!-- Nombres -->
            <label for="correo" class="block text-sm font-medium text-gray-700">Correo</label>
            <input type="email" id="correo_s" value="" name="correo"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
          </div>
          <div class="mb-4">
            <!-- Celular -->
            <label for="celular" class="block text-sm font-medium text-gray-700">Celular</label>
            <input type="text" id="celular_s" value="" name="celular"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
          </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
        ...
        <div class="mb-4">
          <!-- Región -->
          <label for="region" class="block text-sm font-medium text-gray-700">Región</label>
          <select id="region_s" value="" onchange="cargarProvinciasM()" name="region"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            <option value="">Selecciona una región</option>
            <?php foreach ($regiones as $region): ?>
              <option value="<?= $region['id_region'] ?>">
        ...
        <div class="mb-4">
          <!-- Provincia -->
          <label for="provincia" class="block text-sm font-medium text-gray-700">Provincia</label>
          <select id="provincia_s" value="" onchange="cargarComunasM()" name="provincia"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            <option value="">Selecciona una provincia</option>
        ...
        <div class="mb-4">
          <!-- Comuna -->
          <label for="comuna" class="block text-sm font-medium text-gray-700">Comuna</label>
          <select id="comuna_s" value="" name="comuna"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            <option value="">Selecciona una comuna</option>
