              ...
              <div>
                ...
                <div class="mt-2 space-y-2 gap-1">
                  <div>
                    ...
                    <label for="1" class="flex items-center py-1 px-10 text-gray-500  bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="2" name="hosting" value="2" class="hidden peer w-full" required>
                    <label for="2" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="3" name="hosting" value="3" class="hidden peer w-full" required>
                    <label for="3" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="4" name="hosting" value="4" class="hidden peer w-full" required>
                    <label for="4" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="5" name="hosting" value="5" class="hidden peer w-full" required>
                    <label for="5" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="6" name="hosting" value="6" class="hidden peer w-full" required>
                    <label for="6" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="mt-2 space-y-2 gap-1">
                  <div class="w-full">
                    ...
                    <label for="7" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="8" name="hosting" value="8" class="hidden peer w-full" required>
                    <label for="8" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="9" name="hosting" value="9" class="hidden peer w-full" required>
                    <label for="9" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="10" name="hosting" value="10" class="hidden peer w-full" required>
                    <label for="10" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="11" name="hosting" value="11" class="hidden peer w-full" required>
                    <label for="11" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                  <div>
                    <input type="radio" id="12" name="hosting" value="12" class="hidden peer w-full" required>
                    <label for="12" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-blue-600 dark:text-gray-400">
                      09:00
                    </label>
                  </div>
                </div>
