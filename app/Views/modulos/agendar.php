...
<body class="bg-gray-100">
  ...
  <div class=" flex items-center justify-center h-screen mb-32 md:mb-0 ">
            ...
            <div>
              ...
              <div class="mt-2 space-y-2 gap-1">
                ...
                <?php foreach ($horarios as $horario) : ?>
                  <?php if ($count <= 6) : ?>
                    <div>
                      <input type="radio" id="<?= $horario['id_horario'] ?>" name="horario" value="<?= $horario['id_horario'] ?>" class="hidden peer w-full" required>
                      <label for="<?= $horario['id_horario'] ?>" class="flex items-center py-1 px-10 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400"><?= $horario['hor_hora_medica'] ?></label>
                    </div>
                  <?php endif; ?>
                  <?php $count++; ?>
                <?php endforeach; ?>
  ...
  <script>
    ...
    const disabledDates = [...today.getDate() - 1];
