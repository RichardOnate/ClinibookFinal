...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
  ...
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <ul class="space-y-2 font-medium">
      ...
      <!--  inicio -->
      <li>
        <a href="/dashboard/admin" class=" flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'admin') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!-- Perfil -->
      <li>
        <a href="/admin-perfil" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'admin-perfil') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!-- Trabajadores -->
      <li>
        <a href="/admin-trab" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'admin-trab') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!-- Pacientes -->
      <li>
        <a href="/admin-paci" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'admin-paci') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!-- Reportes -->
      <li>
        <a href="/admin-reportes" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'admin-reportes') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!--Desconectar  -->
      <li>
        <a href="/cerrar-sesion" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-red-700 dark:hover:bg-gray-700 group">
