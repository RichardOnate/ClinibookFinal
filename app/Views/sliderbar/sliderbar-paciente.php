...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
  ...
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    <a href="/paciente" class="flex items-center ps-2.5 mb-5">
    ...
    <ul class="space-y-2 font-medium">
      <li class="max-w-xs p-4 bg-blue-700 border border-gray-200 rounded-lg shadow">
        ...
        <p class="text-gray-300">Paciente</p>
        <p id="hora" class="text-gray-100  text-xl"></p>
        <p id="fecha" class="text-gray-100  text-md"></p>
      </li>
      <!-- inicio -->
      <li>
        <a href="/paciente" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'paciente') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!-- Historial -->
      <li>
        <a href="/paciente-historial" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'paciente-historial') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!--Ver documentos-->
      <li>
        <a href="/paciente-documentos" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'paciente-documentos') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">Ver Documentos</span>
        </a>
      </li>
      <!-- Fin ver documentos -->
