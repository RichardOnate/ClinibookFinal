  ...
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <ul class="space-y-2 font-medium">
      <li class="max-w-xs p-4 bg-blue-700 border border-gray-200 rounded-lg shadow">
        ...
        <p class="text-gray-300">Recepcionista</p>
      ...
      <!--Desconectar  -->
      <li>
        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-red-700 dark:hover:bg-gray-700 group">
