...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
  ...
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
    ...
    <ul class="space-y-2 font-medium">
      ...
      <!-- inicio -->
      <li>
        <a href="/recep" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'recep') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!-- Perfil -->
      <li>
        <a href="/recep-perfil" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'recep-perfil') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
      ...
      <!--Agendar pacientes-->
      <li>
        <a href="/recep-agendar" class="flex items-center p-2 text-gray-900 rounded-lg <?php echo ($active_page == 'recep-agendar') ? 'bg-blue-700 text-white' : ''; ?> dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
